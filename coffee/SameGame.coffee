window.app =
  config: ->
    @define.x_axis = Number $('#x_axis').val()
    @define.y_axis = Number $('#y_axis').val()
    @define.num = Number $('#num').val()
  ...
  createlist: ->
    for i in [1...@define.x_axis]
      $('#x_axis').append """<option value="#{i}">#{i}</option>"""
    for j in [1...@define.y_axis]
      $('#y_axis').append """<option value="#{j}">#{j}</option>"""
    for n in [2...@define.num]
      $('#num').append """<option value="#{n}">#{n}</option>"""
    $('#x_axis').val("10")
    $('#y_axis').val("10")
    $('#num').val("4")
  ...
  createBlockA: () ->
    ...
    @define.first = []
    @define.delarray = []
    # x_axis = Number $('#x_axis').val()
    # y_axis = Number $('#y_axis').val()
    # num = Number $('#num').val()
